...
>「人的一生如此短暂......我们不可能完成每一件想做的事。无论我们做了什么，总有其他东西值得一试，总有另一条路值得一走。」--Fiding Paradise
...
测试&&对比了一堆开源软件，打磨技术生产力工具，还尝试体验了好几个 Linux 发行版（Fedora、RebornOS、openSUSE、MocaccinoOS、Cauculate Linux etc.）有朝一日也想研究下 Linux from Scratch（LFS）
